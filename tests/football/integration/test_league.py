...
class LeagueTest(TestCase):
    ...
    def test_private_league(self):
        ...
        with self.assertRaises(Exception):
            League(
                368876,
                2018,
                "AEF1234567890ABCDE1234567890ABCD",
                "{D0C25A4C-2A0D-4E56-8E7F-20A10B663272}",
            )
    ...
    def test_box_scores(self):
        ...
        self.assertEqual(
            repr(box_scores[1].away_lineup[1]),
        ...
        self.assertEqual(
            player.projected_points_breakdown["receivingTouchdowns"], 3.823115436
        )
