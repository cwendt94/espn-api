...
def _make_box_player_data(player_id=101, pro_team_id=1, lineup_slot_id=0, default_position_id=1, points=18.5, breakdown=None):
...
class BoxScoreTest(TestCase):
    def test_box_score_repr_uses_byes_when_missing(self):
        score = BoxScore({'winner': 'HOME', 'home': {'teamId': 0}, 'away': {'teamId': 0}}, 1)
