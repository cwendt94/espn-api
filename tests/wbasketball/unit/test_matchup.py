...
from espn_api.wbasketball.matchup import Matchup
...
class MatchupTest(TestCase):
    def test_matchup_fetches_category_details(self):
        ...
        self.assertEqual(matchup.home_final_score, 123.4)
        self.assertEqual(matchup.away_final_score, 118.7)
        self.assertEqual(matchup.home_team_live_score, 2.5)
        self.assertEqual(matchup.home_team_cats["PTS"], {"score": 110.5, "result": "W"})
        ...
        data = {
            ...
            "home": {
                ...
                "cumulativeScore": {
                    "wins": 2,
                    "ties": 0,
                    "scoreByStat": {"0": {"score": 101, "result": "W"}},
                },
            },
            "away": {
                "teamId": 2,
                ...
                "cumulativeScore": {
                    "wins": 1,
                    "ties": 0,
                    "scoreByStat": {"0": {"score": 89, "result": "L"}},
                },
            },
        }

        self.assertEqual(repr(Matchup(data)), "Matchup(1 2.0 - 1.0 2)")
