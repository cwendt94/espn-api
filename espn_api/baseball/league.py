...
class League(BaseLeague):
    ...
    def transactions(self, types: Set[str] = None, scoring_period: int = None, fill_trade_items: bool = False, player_ids: List[int] = None, fill_from: str = 'week') -> List[Transaction]:
