    ...
    def __init__(self, data):
        ...
        self.position = POSITION_MAP.get(
            (
                ...
                if json_parsing(data, "defaultPositionId")
                and json_parsing(data, "defaultPositionId") <= 3
        ...
        self.eligibleSlots = [
            POSITION_MAP.get(pos, "") for pos in json_parsing(data, "eligibleSlots")
        ]
