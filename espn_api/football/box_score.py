...
class BoxScore(object):
    ...
    def __init__(
        ...
        self.home_projected = self._get_projected_score(
        ...
        self.away_projected = self._get_projected_score(
            self.away_projected, self.away_lineup
        )
    ...
    def _get_team_data(
        ...
        team_lineup = [
            BoxPlayer(
                player, pro_schedule, positional_rankings, week, year, player_team_cache
            )
